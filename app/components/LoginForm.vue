<template>
  <div
    class="w-full max-w-md mx-auto bg-gray-900 rounded-lg shadow-2xl p-6 border border-gray-700"
  >
    <!-- Tabs -->
    ...
    <div v-if="activeTab === 'login'" class="space-y-4">
      ...
      <div
        v-if="error"
        class="p-3 rounded-md bg-red-900/20 border border-red-500/50"
      >
    ...
    <div v-if="activeTab === 'register'" class="space-y-4">
      ...
      <div
        v-if="successMessage"
        class="p-3 rounded-md bg-green-900/20 border border-green-500/50"
      >
...
const validateRegisterForm = (): boolean => {
  ...
  if (!registerForm.value.password.trim()) {
    ...
    registerValidationErrors.value.password =
  ...
  if (!registerForm.value.confirmPassword.trim()) {
    registerValidationErrors.value.confirmPassword =
